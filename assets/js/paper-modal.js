...
$(document).ready(function() {
    ...
    const paperData = {
      ...
      A02: {
        ...
        authors:
          "Castellanos Durán, J.S.; Lagg, A.; Solanki, S.K. & van Noort, M.",
        journal: "ApJ 895, 129",
        year: "2020",
        abstract:
      ...
      A06: {
        ...
        authors:
          "Sowmya, K.; Lagg, A.; Solanki, S.K. & Castellanos Durán, J.S.",
      ...
      A07: {
        ...
        authors:
          "Smitha, H.N.; van Noort, M.; Solanki, S.K. & Castellanos Durán, J.S.",
      ...
      A08: {
        ...
        authors:
          "Albert, K.; Hirzberger, J.; Castellanos Durán, J.S.; Orozco Suárez, D.; Woch, J.; Michalik, H. & Solanki, S.K.",
      ...
      A12: {
        ...
        authors:
          "Vukadinović, N.; Smitha, H.N.; Korpi-Lagg, A.; van Noort, M.; Castellanos Durán, J.S. & Solanki, S.K.",
        journal: "A&A 686, A262",
        year: "2024",
        abstract:
          "The reliability of physical parameters describing the solar atmosphere inferred from observed spectral line profiles depends on the accuracy of the involved atomic parameters. For many transitions, atomic data, such as the oscillator strength (log(gf)) and the central wavelength of the line, are poorly constrained or even unknown. We present and test a new inversion method that infers atomic line parameters and the height stratification of the atmospheric parameters from spatially resolved spectropolarimetric observations of the Sun. This method employs a global minimization algorithm enabling the coupling of inversion parameters common to all pixels, such as the atomic parameters of the observed spectral lines. At the same time, it permits the optimum atmospheric parameters to be retrieved individually for each spatial pixel. The uniqueness of this method lies in its ability to retrieve reliable atomic parameters even for heavily blended spectral lines. The new method was able to retrieve the log(gf) values of all lines to an accuracy of 0.004 dex, while the pixel-by-pixel method retrieved the same parameter to an accuracy of only 0.025 dex. The new method is well suited for the reliable determination of both atomic and atmospheric parameters and works well on all spectral lines, including those that are weak and/or severely blended.",
      ...
      A13: {
        ...
        authors:
          "Castellanos Durán, J.S.; Milanovic, N.; Korpi-Lagg, A.; Löptien, B.; van Noort, M. & Solanki, S.K.",
      ...
      A14: {
        ...
        authors:
          "Castellanos Durán, J.S.; Korpi-Lagg, A.; Solanki, S.K.; van Noort, M. & Milanovic, N.",
      ...
      A18: {
        title:
          "Fine-scale opposite-polarity magnetic fields in solar plage revealed by integral field spectropolarimetry",
        authors:
          "Liu, G.; Milic, I.; Castellanos Durán, J.S.; Borrero, J.M.; van Noort, M. & Kuckein, C.",
      ...
      A19: {
        ...
        authors:
          "Castellanos Durán, J.S.; Löptien, B.; Korpi-Lagg, A.; Solanki, S.K. & van Noort, M.",
        journal: "A&A 701, A49",
        year: "2025",
        abstract:
      ...
      A20: {
        ...
        authors:
          "Li, X.; Solanki, S.K.; Wiegelmann, T.; Valori, G.; Calchetti, D.; Hirzberger, J.; Castellanos Durán, J.S. et al.",
      ...
      A21: {
        ...
        authors:
          "Kontogiannis, I.; Zhu, Y.; Barczynski, K.; Stiefel, M.Z.; Collier, H.; McKevitt, J.; Castellanos Durán, J.S. et al.",
      ...
      A22: {
        title:
          "Solar photospheric velocities measured in space: SO/PHI-HRT and SDO/HMI comparison",
        authors:
          "Calchetti, D.; Albert, K.; Bailén, F.J.; Blanco Rodríguez, J.; Castellanos Durán, J.S.; Feller, A. et al.",
